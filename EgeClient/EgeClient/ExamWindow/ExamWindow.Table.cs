...
namespace EgeClient
{
    public partial class ExamWindow : Window
    {
        ...
        {
            // очищаем перед новой генерацией
            ClearTable();

            // создаем определения строк (RowDefinitions)
        ...
        // метод для создания границ ячеек
